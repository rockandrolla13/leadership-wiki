...
## [2026-05-16] ingest | Find Your Why (Sinek, Mead, Docker)
...
## [2026-05-16] ingest | Start with Why (Simon Sinek)
...
## [2026-05-16] ingest | HBR's 10 Must Reads on Leadership Vol. 2
...
## [2026-05-16] ingest | Leading Outside the Lines (Katzenbach & Khan)
...
## [2026-05-16] ingest | Group B — HBR 2025, HBR 2026, HBR Communication Vol.2, HBR Managing Yourself
...
- Sources used by domain:
  ...
  - hbr-must-reads-2025: foundational for [[principles/energy-management]] (empathy), [[coaching/personal-leadership-development]] (Strategize Your Life), [[organization/culture]] (subtraction), [[principles/psychological-safety]] (four freedoms)
  - hbr-must-reads-2026: foundational for [[communication/listening-and-conversation]] (five question domains), [[principles/decision-making-biases]] (uniqueness trap), [[organization/leadership-teams]], [[organization/culture]] (six dilemma rules), [[principles/curiosity]]
  - hbr-communication-vol2: foundational for [[communication/listening-and-conversation]] (four-I + Brooks/John + Toegel/Barsoux + Rosh/Offermann + Detert), [[communication/cross-cultural-negotiation]] (Meyer), [[principles/courage]] (Detert), [[communication/feedback-scripts]] (Heen/Stone three triggers)
- Contradictions / tensions:
  - Sinek's "find your one WHY" vs Coleman's "purpose is built, plural, evolving" — resolved by treating WHY as the deep North Star and *purposes* as the daily operational meanings.
  - Lopp's "say the hard thing" stoic posture vs Zaki's *empathic concern vs emotional empathy* distinction — both can hold; the integration is concern-mode for hard feedback.
  - Existing emphasis on declarative/decisive leadership vs. the new 2026 emphasis on asking-questions-as-leadership-skill — sequencing: declarative on values and unacceptable behaviour; inquiry-heavy on strategy and execution.
  - [[principles/psychological-safety]] safety-as-permission-to-speak vs Keil/Zangrillo's petting-zoo warning — too much safety without disagreement becomes its own pathology; safety should produce productive disagreement, not consensus-by-default.
  - Lopp's face-to-face stance vs Groysberg/Slind's interactivity-via-modern-channels — both can coexist but the wiki should not present face-to-face as the only valid channel.
  - Existing wiki bias toward managing-others vs Drucker's manage-yourself-first frame — new pages live in `wiki/coaching/` to make the boundary explicit.
- Follow-up questions:
  - How does Drucker's "you cannot change yourself" claim square with Andersen's "aspiration is coachable"? Probable answer: traits don't change, but practices and attention do.
  - The five-domain question framework is well-supported strategically — does it apply tactically? Probably yes but less rigorously.
  - Cross & Dillon's microstress remedies assume 2-3 outside groups; what is the minimum viable version for high-caregiving-load or early-career professionals?
